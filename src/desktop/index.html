...
<div class="menu" id="menu">
	<div>
		<div>
			...
			<ul class="menu-list">
				<li><a class="navig" href="#stoimost" id="menu-alko">Алкоголизм</a></li>
				<li><a class="navig" href="#stoimost" id="menu-narko">Наркомания</a></li>
				<li class="last-li"><a class="navig" href="#stoimost" id="menu-psiho">Психологические расстройства</a></li>
			</ul>
...
<section class="problem" id="stoimost">
	<div>
		<div>
			<h2>Выберите проблему с которой столкнулась ваша семья</h2>
			<div class="problems-wrap">
				<div class="problem-item alko">
					<a href="alkogol.php#stoimost">
						<h3>Алкоголизм</h3>
						<p>Хронический <br>Тайный <br>Запойный <br>Пивной <br>Женский</p>
				...
				<div class="problem-item narko">
					<a href="narkomania.php#stoimost">
						<h3>Наркомания</h3>
						<p>Марихуана <br>Героин <br>Амфетамин <br>Кокаин <br>Спайс <br>ЛСД</p>
						<div class="more-btn">Подробнее</div>
					</a>
					<div class="overlay"></div>
				</div>
				<div class="problem-item psiho">
					<a href="psihologia.php#stoimost">
						...
						<p>Депрессия <br>Шизофрения <br>Анарексия <br>Паника <br>ОКР <br>Тревога</p>
						<div class="more-btn">Подробнее</div>
					</a>
					<div class="overlay"></div>
				</div>

...
<section class="header single" id="sec1">
	<div>
		<div>
			<div class="head">
			...
			<div class="main-form">
				<form id="header-form">
					...
					<input class="send-form" type="submit" value="Получить консультацию">
				</form>
	...
	<footer>
		<div class="content">
			...
			<div class="email"><a href="mailto:info@rehabfamily.ru">info@rehabfamily.ru</a></div>
		</div>
	</footer>
</section>

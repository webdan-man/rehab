				...
				<form id="calc-form">
					<div class="wrap-filters">
						...
						<div class="right-filters">
							...
							<div class="line">
								<div>
									<input id="rad3" name="before" type="radio" value="Да">
									<label for="rad3">Да</label>
								</div>
								<div>
									<input id="rad4" name="before" type="radio" value="Нет">
...
<section class="video-sect" id="video-patient">
	<div>
		<div>
			<h2>Посмотрите видео и узнайте почему более <br> 95% пациентов Rehab Family навсегда <br> избавляются от алкоголизма!</h2>

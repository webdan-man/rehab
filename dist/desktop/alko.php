...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/alko.php" + document.location.search; 
	} 
	</script>
	...
	<div>
		<div>
			...
			<div class="header-text">
				...
				<h1>Как победить алкоголизм?</h1>
				<h2>10 основных ошибок при борьбе с <span>алкоголизмом</span> от Курловича Николая Михайловича!</h2>
			</div>
			<div class="header-video auto-video alko">
				<div class="vid-over">
					<div class="video-btn"></div>
				</div>
			</div>
			<div class="main-form">
				<form id="header-form" class="alko_form">
					<p>Получите бесплатно файл с советами "10 ошибок при борьбе с алкоголизмом"</p>
					<input class="person-name" type="email" name="email" placeholder="Ваш email">
...
<div class="hidden-box">
	<div id="callback-modal">
		<div class="main-form">
			...
			<form id="header-popup-form" class="alko_form">
	...
	<div id="download-modal">
		...
		<a class="btn-download" href="/files/alko.pdf" download>Скачать файл</a>
		<div class="box-modal_close arcticmodal-close">закрыть окно</div>
	</div>

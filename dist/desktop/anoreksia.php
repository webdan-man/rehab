...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/anoreksia.php" + document.location.search; 
	} 
	</script>
	...
	<div>
		<div>
			...
			<div class="header-text">
				...
				<h1>Срочно начните лечение против анорексии! <br> Пройдите реабилитационный курс в Rehab family</h1>

...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/anor.php" + document.location.search; 
	} 
	</script>
	...
	<div>
		<div>
			...
			<div class="header-text anor">
				...
				<h1>Как победить анорексию и булимию?</h1>
				<h2>10 основных ошибок при борьбе с <span>анорексией и булимией</span> от Курловича Николая Михайловича!</h2>
			</div>
			<div class="header-video auto-video anor">
				<div class="vid-over">
			...
			<div class="main-form">
				<form id="header-form">
					<p>Получите бесплатно файл с советами "10 ошибок при борьбе с анорексией и булимией"</p>
...
<div class="hidden-box">
	...
	<div id="download-modal">
		...
		<a class="btn-download" href="/files/anor.pdf" download>Скачать файл</a>
		<div class="box-modal_close arcticmodal-close">закрыть окно</div>
	</div>

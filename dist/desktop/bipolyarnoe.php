...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/bipolyarnoe.php" + document.location.search; 
	} 
	</script>
	...
	<div>
		<div>
			...
			<div class="header-text">
				...
				<h1>Избавьтесь от биполярного расстройства! <br> Пройдите реабилитационный курс в Rehab family</h1>

...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/shizo.php" + document.location.search; 
	} 
	</script>
	...
	<div>
		<div>
			...
			<div class="header-text">
				...
				<h1>Как победить шизофрению?</h1>
				<h2>10 основных ошибок при борьбе с <span>шизофренией</span> от Курловича Николая Михайловича!</h2>
			</div>
			<div class="header-video auto-video shizo">
				<div class="vid-over">
			...
			<div class="main-form">
				<form id="header-form">
					<p>Получите бесплатно файл с советами "10 ошибок при борьбе с шизофренией"</p>
...
<div class="hidden-box">
	...
	<div id="download-modal">
		...
		<a class="btn-download" href="/files/shizo.pdf" download>Скачать файл</a>
		<div class="box-modal_close arcticmodal-close">закрыть окно</div>
	</div>

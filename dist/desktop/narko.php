...
<head>
	...
	<script> 
	if (screen.width <= 800) { 
	document.location = "/mobile/narko.php" + document.location.search; 
	} 
	</script>
...
<section class="header single one-one" id="sec1">
	<div>
		<div>
			...
			<div class="header-text nark">
				<!-- <p>Семейная клиника психического здоровья и лечения зависимостей</p> -->
				<h1>Как победить наркозависимость?</h1>
				<h2>10 основных ошибок при борьбе с <span>наркозависимостью</span> от Курловича Николая Михайловича!</h2>
			</div>
			<div class="header-video auto-video narko">
				<div class="vid-over">
			...
			<div class="main-form">
				<form id="header-form">
					<p>Получите бесплатно файл с советами "10 ошибок при борьбе с наркозависимостью"</p>
...
<div class="hidden-box">
	...
	<div id="download-modal">
		...
		<a class="btn-download" href="/files/narko.pdf" download>Скачать файл</a>
		<div class="box-modal_close arcticmodal-close">закрыть окно</div>
	</div>

...
<section class="header single one-one" id="sec1">
	<div>
		<div>
			<div class="head">
				...
				<div class="logo">
					...
					<!-- <p>Семейная клиника психического <br> здоровья и лечения зависимостей</p> -->
				</div>
				<div class="callback">
					<a href="tel:74953200124" class="comagic_phone_link">+7 (495) 320-01-24</a>
					<!-- <p class="all-day">Работаем 24/7</p> -->
					<div class="callback-btn">Заказать звонок</div>
				</div>
			</div>
			<div class="header-text anor">
				<!-- <p>Семейная клиника психического здоровья и лечения зависимостей</p> -->
				<h1>Как победить расстройства психики?</h1>
				<h2>10 основных ошибок при борьбе с <span>психическими растройствами</span> от Курловича Николая Михайловича!</h2>
			</div>
			<div class="header-video auto-video psihiatr">
				<div class="vid-over">
					<div class="video-btn"></div>
				</div>
			</div>
			<div class="main-form anor">
				<form id="header-form">
					<p>Получите бесплатно файл с советами "10 ошибок при борьбе с психическими растройствами"</p>
					<input class="person-name" type="text" name="email" placeholder="Ваш email">
					...
					<input type="hidden" name="typefrm" value="alko">
					<input class="send-form" type="submit" value="Получить файл">
				</form>
...
<section class="glav-vrach">
	<div>
		<div>
			<h2>Курлович Николай Михаилович - главный врач Rehab Family</h2>
			<div class="left-part">
				<img src="img/workers/10.jpg" alt="qweqe2">
			</div>
			<div class="right-part">
				<p>Закончил Гродненский государственный медицинский университет. Прошел интернатуру по специальности психиатрия-наркология.</p>
				<p>Неоднократно участвовал в отечественных и международных конференциях по организации здравоохранения, а также лечению и реабилитации пациентов с психическими расстройствами.</p>
				<p>С 2007 по 2012 помог более 13 тысячам пациентов, страдающих психическими расстройствами в рамках амбулаторного приема - это до 40 пациентов в день!</p>
				<p>С 2012 по 2014 ежемесячно курировал лечение 30 пациентов в условиях стационара будучи заведующим медицинского отделения.</p>
				<p>С 2014 года - пост Главного Врача клиники Rehab Family. За этот период под руководством Николая Михайловича более 1000 пациентов избавились от различных проблем связанных с растройством психики и зависимостей.</p>
			</div>
		</div>
	</div>
	<footer>
		<div class="content">
			<div class="email"><a href="mailto:ac@rehabfamily.ru">ac@rehabfamily.ru</a></div>
			<div class="name">ООО "Рехаб Восстановление"</div>
			<div class="address">Москва, Малый Ивановский переулок, д.6, стр.2</div>
		</div>
	</footer>
</section>
...
<div class="hidden-box">
	...
	<div id="download-modal">
		<p>Спасибо! <br>Для получения файла, нажмите "скачать файл"</p>
		<a class="btn-download" href="/files/psihiatr.pdf" download>Скачать файл</a>
		<div class="box-modal_close arcticmodal-close">закрыть окно</div>
	</div>
